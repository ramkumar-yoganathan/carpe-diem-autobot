...
public final class CandleStickCallStrategy
{
    ...
    private static final Logger LOGGER = Logger.getLogger(CandleStickCallStrategy.class.getName());
    ...
    private CandleStickCallStrategy()
    {
    }
